...
const AllTouristSpotDetails = () => {
    const allTouristSpotDetails = useLoaderData()
    const { country, photo, location, seasonality } = allTouristSpotDetails;
    return (
        <div className="mx-auto my-5 max-w-[350px] space-y-6 rounded-xl bg-white px-4 pb-8 pt-4 font-sans shadow-lg">
            ...
            <div className="mx-auto w-[85%] space-y-5 text-center font-semibold">
                ...
                <Link to='/allTouristSpot'><button className="rounded-lg bg-[#49B2FF] px-4 py-2 font-sans font-semibold text-white 
                duration-300 hover:scale-105 hover:bg-sky-600">Back</button></Link>
            </div>
        </div>
    );
};
